...
#include <vector>
#include <memory>
#include "GLViewOptimizationsModule.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewOptimizationsModule > glView( Aftr::GLViewOptimizationsModule::New( args ) );
